...
const validationSchema: yup.ObjectSchema<IFormInputs> = yup.object().shape({
    supplierId: yup.mixed<Supplier>().nullable().required('Tedarikçi seçimi zorunludur'),
...
const suppliers: Supplier[] = [
  { id: 1, label: 'ABC Tedarik A.Ş.', address: 'Sanayi Mah. Üretim Cad. No:15 D:3, İstanbul', taxOffice: 'Beylikdüzü', taxNo: '1234567890' },
  { id: 2, label: 'XYZ Malzeme Ltd.', address: 'Organize Sanayi Bölgesi 5. Cad. No:8, Ankara', taxOffice: 'Ostim', taxNo: '0987654321' },
  { id: 3, label: 'Güven Tedarikçi A.Ş.', address: 'İndustri Mah. Fabrika Sk. No:12, İzmir', taxOffice: 'Bornova', taxNo: '5555666677' },
  { id: 4, label: 'Kalite Malzeme Ltd.', address: 'Merkez Mah. Ticaret Cad. No:25, Bursa', taxOffice: 'Nilüfer', taxNo: '3333444455' },
];
      ...
      >
        ...
        >
          ...
          <Typography variant="body2" sx={{ opacity: 0.9, mt: 1 }}>
            Tedarikçi ve fatura detaylarını eksiksiz doldurunuz
          </Typography>
        </Box>
                ...
                {selectedSupplier && (
                  ...
                  >
                    <Typography variant="subtitle2" fontWeight="bold" color="#25638f" sx={{ mb: 1 }}>
                      Seçilen Tedarikçi Detayları
                    </Typography>
                    <Typography variant="body2" sx={{ mb: 1 }}>
                      📍 {selectedSupplier.address}
                    </Typography>
                    <Typography variant="body2" color="text.secondary">
                      🏢 Vergi Dairesi: {selectedSupplier.taxOffice}
                    </Typography>
                    <Typography variant="body2" color="text.secondary">
                      📄 Vergi No: {selectedSupplier.taxNo}
                    </Typography>
                  </Box>
                )}
              </Box>
